...
<html lang="en">
<head>
	<title>All Users - Admin Megablogging</title>
					...
					<?PHP
						if (isset($_GET['msg'])){
							...
							if ($msg==1){ //success add new category
								$m_tipe = 'success';
								$messages = "<strong>Success!</strong> adding new user!";
							}else if($msg==2){
								$m_tipe = 'success';
								$messages = "<strong>Success!</strong>... deleting user!";
							}else{
								$m_tipe = 'danger';
                        ...
                        <div class="panel panel-default" id='all'>
                            ...
                            <div class="panel-body">
								<div id='top-action' style='margin-bottom:10px'>
									<a href='add_user.mgb' class='btn btn-success'><i class='fa fa-plus'></i> Add New User</a>
