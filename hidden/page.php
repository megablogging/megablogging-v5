...
<html lang="en">
<head>
	<title>All Pages - Admin Megablogging</title>
					...
					<?PHP
						if (isset($_GET['msg'])){
							...
							if ($msg==1){ //success add new category
								$m_tipe = 'success';
								$messages = "<strong>Success!</strong> add new pages!";
							}else if($msg==2){
								$m_tipe = 'success';
								$messages = "<strong>Success!</strong>... delete pages!";
							}else if($msg==3){
								$m_tipe = 'success';
								$messages = "<strong>Success!</strong>... edit pages!";
							}else{
								$m_tipe = 'danger';
					...
					<div class="col-md-12">
                        <div class="panel panel-default" id='all'>
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-file-o"></i> All Pages</h3>
                            ...
                            <div class="panel-body">
								<div id='top-action' style='margin-bottom:10px'>
									<a href='add_page.mgb' class='btn btn-success'><i class='fa fa-plus'></i> Add New Pages</a>
