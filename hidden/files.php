...
require_once("act/files.mgb");
?>
<!DOCTYPE html>
<html lang="en">
<head>
	<title>All Files - Admin Megablogging</title>
...
<body>
					...
					<?PHP
						if (isset($_GET['msg'])){
							...
							if ($msg==1){ //success add new category
								$m_tipe = 'success';
								$messages = "<strong>Success!</strong> deleting file!";
							}else{
								$m_tipe = 'danger';
					...
					<div class="col-md-12">
                        <div class="panel panel-default" id='all'>
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fs fs-file-zip"></i> All Files</h3>
                            ...
                            <div class="panel-body">
								<div id='top-action' style='margin-bottom:30px'>
									<a href='up_files.mgb' class='btn btn-success btn-sm'><i class='fa fa-upload'></i> Upload Files</a>
	...
	<script type='text/javascript'>
		...
		function changePagination(page, action, q){
			...
			$.ajax({
				type: "POST",
				url: "proses/ajax_load_files.php",
				data: dataString,
				cache: false,
